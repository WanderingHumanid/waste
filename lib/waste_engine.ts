...
export class WasteEngine {
  ...
  private initializeZones() {
    const piravomZones = [
      {
        id: 'zone_001',
        name: 'Piravom Central Bus Stand',
        lat: 9.8667,
        lon: 76.5018,
        bin_capacity: 800,
        generation_rate: 0.148,
      },
      {
        id: 'zone_002',
        name: 'Piravom Railway Station',
        lat: 9.8675,
        lon: 76.5040,
        bin_capacity: 750,
        generation_rate: 0.138,
      },
      {
        id: 'zone_003',
        name: 'Piravom Main Market Road',
        lat: 9.8660,
        lon: 76.5015,
        bin_capacity: 900,
        generation_rate: 0.167,
      },
      {
        id: 'zone_004',
        name: 'Piravom Hospital Junction',
        lat: 9.8650,
        lon: 76.5010,
        bin_capacity: 700,
        generation_rate: 0.130,
      },
      {
        id: 'zone_005',
        name: 'Government College Main Gate',
        lat: 9.8650,
        lon: 76.5035,
        bin_capacity: 650,
        generation_rate: 0.120,
      },
      {
        id: 'zone_006',
        name: 'Piravom Central School Road',
        lat: 9.8675,
        lon: 76.5002,
        bin_capacity: 600,
        generation_rate: 0.111,
      },
      {
        id: 'zone_007',
        name: 'Shopping Complex Lane',
        lat: 9.8668,
        lon: 76.4995,
        bin_capacity: 850,
        generation_rate: 0.157,
      },
      {
        id: 'zone_008',
        name: 'Piravom Public Park Entrance',
        lat: 9.8655,
        lon: 76.5025,
        bin_capacity: 500,
        generation_rate: 0.093,
      },
      {
        id: 'zone_009',
        name: 'Hotel Food Street Junction',
        lat: 9.8680,
        lon: 76.5020,
        bin_capacity: 700,
        generation_rate: 0.130,
      ...
      {
        id: 'zone_010',
        name: 'West Residential Road',
        lat: 9.8665,
        lon: 76.4978,
        bin_capacity: 450,
        generation_rate: 0.083,
      },
      {
        id: 'zone_011',
        name: 'North Residential Main Road',
        lat: 9.8690,
        lon: 76.5025,
        bin_capacity: 480,
        generation_rate: 0.089,
      },
      {
        id: 'zone_012',
        name: 'South Residential Lane',
        lat: 9.8640,
        lon: 76.5008,
        bin_capacity: 550,
        generation_rate: 0.102,
      },
    ]
